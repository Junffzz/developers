...
func main() {
    ...
    var logString = `{"user_id":"57788","mod_info":{"year_id":23, "realname":"zjftest20210707"}}`
    msg.Value = sarama.StringEncoder(logString)
    client, err := sarama.NewSyncProducer([]string{"10.90.73.67:9092", "10.90.73.77:9092", "10.90.73.100:9092"}, config)
    if err != nil {
